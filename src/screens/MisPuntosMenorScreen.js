...
export default function MisPuntosMenorScreen({ navigation }) {
  const insets = useSafeAreaInsets();
  const { currentUser, getUserLoyaltyPoints, getLoyaltyHistory, redeemTokensTiered, LOYALTY_RATES, TOKEN_REDEEM_OPTIONS } = useGlobal();
      ...
      <ScrollView contentContainerStyle={[styles.scroll, Platform.OS === 'ios' && { paddingTop: 16 + insets.top }]} showsVerticalScrollIndicator={false}>
        ...
        {tab === 'canjear' && (
          <View style={styles.card}>
            ...
            <Text style={styles.redeemHint}>Elegí cuántos tokens querés recibir</Text>
              ...
              {TOKEN_REDEEM_OPTIONS.map((opt, i) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      if (!enough) {
                        Alert.alert('Puntos insuficientes', `Todavía no tenés los puntos suficientes.`, [{ text: 'Entendido', style: 'cancel' }]);
                        return;
                      }
          ...
          <View style={styles.card}>
            ...
            <View style={styles.rateRow}>
              ...
              <View style={styles.rateInfo}>
                <Text style={styles.rateLabel}>Tarea aprobada</Text>
                <Text style={styles.rateDesc}>Cuando el tutor aprueba una tarea que completaste</Text>
              </View>
            ...
            <View style={styles.rateRow}>
              ...
              <View style={styles.rateInfo}>
                ...
                <Text style={styles.rateDesc}>Cuando abrís una sorpresa que te enviaron</Text>
              </View>
